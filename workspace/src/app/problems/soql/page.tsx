...
const SectionHeading = ({ title, children }: { title: string, children: React.ReactNode }) => (
    <div className="mb-8">
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <p>
            ...
            <Link href="/problems/soql/Basics" className="text-primary font-medium hover:underline">
              SOQL Problems
            </Link>{' '}
              ...
              {[...Array(15)].map((_, i) => (
                <div
                  ...
                  className={`h-6 w-4 rounded-sm ${
                    i >= 5 && i < 10 ? 'bg-primary/80' : 'bg-muted'
                  }`}
                ></div>
              ))}
            </div>
...
const PerformanceSecurityContent = () => (
    <div>
