...
import { Loader2, PlusCircle, Trash2, Edit, GripVertical, ArrowLeft, UploadCloud, ChevronDown, Code, Type, Image as ImageIcon, Video, Mic, List, CheckSquare, MessageSquare, AlertCircle, Divide, Puzzle, BrainCircuit, Columns, ListOrdered, PlayCircle, ToggleRight, GitBranch, Play, Link2 } from "lucide-react";
...
function ModuleItem({ moduleIndex, courseId, onRemove }: { moduleIndex: number, courseId: string, onRemove: () => void }) {
    const { control, getValues, register } = useFormContext<z.infer<typeof courseFormSchema>>();
