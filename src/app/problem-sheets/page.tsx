    ...
    <main className="flex-1 container py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
          <Tabs value={filterMode} onValueChange={(value) => setFilterMode(value as any)} className="w-full md:w-auto">
              <TabsList>
                  <TabsTrigger value="all" isActive={filterMode === 'all'}>All Sheets</TabsTrigger>
                  <TabsTrigger value="my-sheets" isActive={filterMode === 'my-sheets'} disabled={!authUser}>My Sheets</TabsTrigger>
                  <TabsTrigger value="following" isActive={filterMode === 'following'} disabled={!authUser}>Following</TabsTrigger>
              </TabsList>
          </Tabs>
