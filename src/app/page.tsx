...
const SkillCard = ({
  ...
  <div
    className={`flex items-center justify-between p-4 rounded-full border transition-all duration-300 hover:scale-105 hover:border-foreground/80 ${borderColor}`}
  >
